...
rec {
  ...
  rootCrate = rec {
    packageId = "bin_with_git_submodule_dep 0.1.0 (path+file:///home/bemeurer/src/crate2nix/sample_projects/bin_with_git_submodule_dep)";
  ...
  crates = {
    ...
    "bin_with_git_submodule_dep 0.1.0 (path+file:///home/bemeurer/src/crate2nix/sample_projects/bin_with_git_submodule_dep)"
      = rec {
