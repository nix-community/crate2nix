...
rec {
  ...
  rootCrate = rec {
    packageId = "using_compiler_builtins";
    ...
    crates = {
      "compiler_builtins" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "2541f27e8c3d61505815c0492c045b7d17436e35";
          sha256 = "12l9r6hz15nrvsbil9i9b7nsv2n8k04vi4klffirbwhgg1isw9p0";
        };
        authors = [
      ...
      "using_compiler_builtins" = rec {
        crateName = "using_compiler_builtins";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "using_compiler_builtins"; path = "src/main.rs"; }
        ];
