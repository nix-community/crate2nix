...
rec {
  ...
  rootCrate = {
    packageId = "multiple_bin 0.1.0 (path+file:///home/kris/git/crate2nix/sample_projects/multiple_bin)";
  ...
  crates = {
    "multiple_bin 0.1.0 (path+file:///home/kris/git/crate2nix/sample_projects/multiple_bin)"
      = rec {
        crateName = "multiple_bin";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "bin1"; path = "src/bin1.rs"; }
          { name = "bin2"; path = "src/bin2.rs"; }
          { name = "multiple_bin"; path = "src/main.rs"; }
        ];
        src = (builtins.filterSource sourceFilter ./.);
        authors = [
          "Kristoffer Søholm <k.soeholm@gmail.com>"
        ];
        features = {
        };
      };
