...
rec {
  ...
  rootCrate = rec {
    packageId = "renamed_build_deps 0.1.0 (path+file:///home/andi/dev/tweag/sc/crate2nix/sample_projects/renamed_build_deps)";
  ...
  crates = {
    ...
    "renamed_build_deps 0.1.0 (path+file:///home/andi/dev/tweag/sc/crate2nix/sample_projects/renamed_build_deps)"
      = rec {
