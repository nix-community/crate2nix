...
rec {
  ...
  crates = {
    ...
    "dependency_issue_65 0.1.0 (path+file:///home/peter/projects/crate2nix/sample_projects/dependency_issue_65)" = rec {
    ...
    "diesel 1.4.3 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
      crateName = "diesel";
      version = "1.4.3";
      edition = "2015";
    ...
    "diesel_derives 1.4.1 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
    ...
    "pq-sys 0.4.6 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
      crateName = "pq-sys";
      version = "0.4.6";
      edition = "2015";
    ...
    "r2d2 0.8.8 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
      crateName = "r2d2";
      version = "0.8.8";
      edition = "2018";
    ...
    "scheduled-thread-pool 0.2.3 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
