...
rec {
  ...
  rootCrate = rec {
    packageId = "crate2nix 0.7.0-alpha.7 (path+file:///home/cloud/Documents/code/nix/crate2nix/crate2nix)";
  ...
  crates = {
    ...
    "crate2nix 0.7.0-alpha.7 (path+file:///home/cloud/Documents/code/nix/crate2nix/crate2nix)"
      = rec {
        crateName = "crate2nix";
        ...
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait 0.1.22 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            name = "cargo_metadata";
    ...
    "tokio 0.2.11 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "libc" "mio" "mio-named-pipes" "mio-uds" "process" "signal" "signal-hook-registry" "winapi" ];
      };
