...
* Provide `shell.nix` via [flake-compat](https://github.com/edolstra/flake-compat). @kolloch
* Provide an "old-school" `pkgs.callPackage`-compatible `default.nix` for the `crate2nix` binary. @kolloch
